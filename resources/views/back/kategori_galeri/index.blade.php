    ...
    @include('layouts.sidebar')
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div class="container-fluid">
          <div class="container-fluid">
            <h1 class="h3 mb-2 text-gray-800">Kategori Galeri</h1>
              <div class="card shadow mb-4">
                <div class="col-sm-12 col-md-12 mt-3">
                  <a href="{{  route('kategori_galeri.create') }}" class="btn btn-success btn-icon-split">
                      ...
                      <tbody>
                        @foreach($kategori as $row)
                            <tr>
                                ...
                                <td>{{ $row->slug }}</td>
                                <td>
                                    <a href="{{ route('kategori_galeri.edit', $row->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                </td>
                                <td>    
                                    <form class="" action="{{ route('kategori_galeri.destroy', $row->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
