            ...
            <h1 class="h3 mb-2 text-gray-800">Fasilitas</h1>
              <div class="card shadow mb-4">
                <div class="col-sm-12 col-md-12 mt-3">
                  <a href="{{  route('fasilitas.create') }}" class="btn btn-success btn-icon-split">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        @foreach($data as $row)
                           <tr>
                            <td><img src="{{ URL::to('/') }}/img/fasilitas_img/{{ $row->gambar }}" class="img-thumbnail" width="75" /></td>
                            <td>{{ $row->judul }}</td>
                            ...
                            <td>    
                                    <form class="" action="{{ route('fasilitas.destroy', $row->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
