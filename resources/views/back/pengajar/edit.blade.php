        ...
        <div class="container-fluid">
          <div class="container-fluid">
            <h1 class="h3 mb-2 text-gray-800">Pengajar</h1>
              ...
              @endif
            <div class="card-body">
              <form method="post" action="{{ route('pengajar.update', $data->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                ...
                <div class="form-group">
                    <label for="">Keterangan</label>
                        <div>
                            <textarea id="ckeditor" type="text" name="keterangan" rows="10" class="form-control input-lg">{{ $data->keterangan }}</textarea>
                       </div>
                </div>
                    ...
                    <label for="">Foto</label>
                        <div>
                            <input type="file" name="foto" />
                                <img src="{{ URL::to('/') }}/img/pengajar_img/{{ $data->foto }}" class="img-thumbnail" width="100" />
