            ...
            <h1 class="h3 mb-2 text-gray-800">Kategori Berita</h1>
              <div class="card shadow mb-4">
                <div class="col-sm-12 col-md-12 mt-3">
                  <a href="{{  route('kategori_berita.create') }}" class="btn btn-success btn-icon-split">
                      ...
                      <tbody>
                        @foreach($kategori as $row)
                            <tr>
                                ...
                                <td>{{ $row->slug }}</td>
                                <td>
                                    <a href="{{ route('kategori_berita.edit', $row->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                </td>
                                <td>    
                                    <form class="" action="{{ route('kategori_berita.destroy', $row->id) }}" method="post">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
