...
<head>
    ...
    <meta charset="UTF-8">
    <title>{{$pengajars->nama}} | {{$title}}</title>
                ...
                <div class="col-lg-8">
                    <div class="blog-details">
                        <div class="post-thumb relative">
                            <div class="overlay overlay-bg"></div>
                            <img class="img-fluid" src="{{ URL::to('/') }}/img/pengajar_img/{{ $pengajars->foto }}" alt="">
                        </div>
                        <div class="post-details">
                        	<ul class="tags">
                                <li>{{ $pengajars->created_at->format('d, M Y')  }}</li>
                            </ul>
                            <h1>{{ $pengajars->nama }}</h1>
                            <p>{!! html_entity_decode($pengajars->keterangan) !!}</p>
                        </br>
                        <a class="primary-btn" href="{{ url('/pengajar') }}">Pengajar
