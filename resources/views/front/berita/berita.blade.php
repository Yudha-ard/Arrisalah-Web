...
<body>
    ...
    <section class="page-top-banner section-gap-full relative" data-stellar-background-ratio="1">
                    ...
                    <div class="blog-lists">
                        ...
                        <div class="single-blog-post">
                            <div class="post-thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="{{ URL::to('/') }}/img/berita_img/{{ $ba->gambar }}" alt="">
                            </div>
                            <div class="post-details">
                                <ul class="tags">{{ $ba->kategori->nama }}
                                </ul>
                                <a href="{{ url('berita', $ba)}}">
                                    <h1>{{ $ba->judul }}</h1>
                                </a>
                                <h5>{!! html_entity_decode(str_limit($ba->konten, 10,'...Read More')) !!}</h5>
                                <div class="user-details d-flex align-items-center">
                                    <div class="details">
                                        <p>{{ $ba->created_at->format('d, M Y')  }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-wrap">
                        <div class="single-widget search-widget">
                            ...
                            <div class="sidebar-form">
                                ...
                                <form action="{{ url()->current() }}"  class="relative {{ (!empty('search')) ? 'search' : null }}">
                                    @csrf
                            ...
                            <ul>
                                ...
                                <li class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="details">
                                        ...
                                        <p class="text-uppercase">{{ $ba->created_at->format('d, M Y') }}</p>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
