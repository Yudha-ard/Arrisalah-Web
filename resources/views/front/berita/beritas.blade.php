...
<head>
    ...
    <meta charset="UTF-8">
    <title>{{$beritas->judul}} | {{$title}}</title>
...
<body>
        ...
        <div class="container">
            <div class="row section-gap-half">
                <div class="col-lg-12 text-center">
                    ...
                    <h2>{{ $beritas->judul }} | <small>{{ $beritas->kategori->nama }}</small></h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="blog-lists-section section-gap-full">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-details"  style="height: auto !important;">
                        <div class="post-thumb relative">
                            <div class="overlay overlay-bg"></div>
                            <img class="img-fluid" src="{{ URL::to('/') }}/img/berita_img/{{ $beritas->gambar }}" alt="">
                        </div>
                        <div class="post-details"  style="height: auto !important;">
                            <ul class="tags">
                                <li><h4>{{ $beritas->kategori->nama }} | <small>{{ $beritas->created_at->format('d, M Y')  }}</small></h4></li>
                            </ul>
                            <h1>{{ $beritas->judul }}</h1>
                            <div>{!! html_entity_decode($beritas->konten) !!}</div>
                        </br>
                            <a class="primary-btn" href="{{ url('/berita') }}">Berita
