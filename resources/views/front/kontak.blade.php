...
<!-- Start page-top-banner section -->
    <section class="page-top-banner section-gap-full relative" data-stellar-background-ratio="0.5" style="background-position: 0px 0px;">
            ...
            <div class="row address-wrap justify-content-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 single-address-col">
                    <div class="div">
                        ...
                        <p>
                            Wonokerto Selatan, Kec. Peterongan, Kab. Jombang, 
                            <br> Jawa Timur 61481
                        </p>
                    </div>
                </div>
