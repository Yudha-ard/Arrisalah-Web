...
<head>
    ...
    <meta charset="UTF-8">
    <title>{{$galeris->judul}} | {{$title}}</title>
                ...
                <div class="col-lg-8">
                    <div class="blog-details">
                        <div class="post-thumb relative">
                            <div class="overlay overlay-bg"></div>
                            <img class="img-fluid" src="{{ URL::to('/') }}/img/galeri_img/{{ $galeris->gambar }}" alt="">
                        </div>
                        <div class="post-details">
                        	<ul class="tags">
                                <li>{{ $galeris->created_at->format('d, M Y')  }}</li>
                            </ul>
                            <h1>{{ $galeris->judul }}</h1>
                            <p>{!! html_entity_decode($galeris->keterangan) !!}</p>
                        </br>
                            <a class="primary-btn" href="{{ url('/galeri') }}">Galeri
