                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 cl">
                            <div class="single-portfolio">
                                <img class="img-fluid" src="{{ URL::to('/') }}/img/galeri_img/{{ $g->gambar }}" alt="">
                                <div class="box-content">
                                    <a href="{{ url('galeri', $g)}}">
                                        <h5 class="title">{{ $g->judul }}</h5>
                                    </a>
                                    <span class="post">{!! html_entity_decode(str_limit($g->keterangan, 10,'...Read More')) !!}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
